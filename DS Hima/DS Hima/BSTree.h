...
private:
	...
	static int rec_CountGreater(Node* subRoot, int Value); // LAB 6 EXERCISE B4
	static bool rec_DeleteExactlyOneChild(Node*& subRoot); // LAB 6 EXERCISE C5
...
public:
	...
	int max_depth() const;
	int CountGreater(int Value); // LAB 6 EXERCISE B4
	bool DeleteExactlyOneChild(); // LAB 6 EXERCISE C5
